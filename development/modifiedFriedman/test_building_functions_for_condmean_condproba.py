...
condproba_1D = icscream_7.build_1D_conditional_exceedance_probability_as_PythonFunction("X3")
condproba_1D.draw(0.0, 1.0, 100)

#%% BUILD 2D COND PROBA
res_2dcondproba = icscream_7.build_2D_conditional_exceedance_probability("X1","X3")

ot.ResourceMap.SetAsString("Contour-DefaultColorMap", 'viridis')
ot.ResourceMap.SetAsBool("Contour-DefaultIsFilled", True)
condproba_2D = icscream_7.build_2D_conditional_exceedance_probability_as_PythonFunction("X1","X3")
...
allcondproba = icscream_7.build_allpenalized_conditional_exceedance_probability_as_PythonFunction()
